...
public class StockTurnoverDiff extends Configured implements Tool {
...
//Value- always Text
		...
		public void map(LongWritable key, Text value, Context context)
		   ...
		   try {
			   ...
			   double aclose = Double.valueOf(tokens[6]);;
                	long var = (long) ((aclose *volume)- (open*volume));
       ...
       public static void main(String[] args) throws Exception {
		int ret = ToolRunner.run(new StockTurnoverDiff(), args);
		System.exit(ret);
	   }
	...
	public int run(String[] args) throws Exception {
		Job job = new Job();
		job.setJarByClass(StockTurnoverDiff.class);
